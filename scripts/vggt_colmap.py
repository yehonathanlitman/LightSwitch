...
def parse_args():
    ...
    parser.add_argument("--image_dir_name", type=str, required=True, help="Image directory name within scene_dir")
...
def demo_fn(args):
    ...
    image_dir = os.path.join(args.scene_dir, args.image_dir_name)
